...
Funcion Crea_Pantalla ( var_nombre Por referencia )
	// en un llamado por REFERENCIA la variable afectada SE PUEDE MODIFICAR
	escribir "Estás en -> SubProceso FUNCION."
	escribir "Valor almacenado en var_nombre:",var_nombre
	var_nombre = "José" //en llamada por REFERENCIA se modifica la variable original
...
Algoritmo sin_titulo
	...
	escribir "En llamada por REFERENCIA SE PUEDE MODIFICAR la variable original"
	escribir "------------------------------"
